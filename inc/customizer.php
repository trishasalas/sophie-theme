 ...
 */
function sophie_customize_register( $wp_customize ) {
	...
	class sophie_Customize_Textarea_Control extends WP_Customize_Control {
	...
	$wp_customize->add_control(
		new sophie_Customize_Textarea_Control(
			$wp_customize,
			'textarea',
			array(
				'label' => '',
 ...
 */
function sophie_customize_preview_js() {

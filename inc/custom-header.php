...
function sophie_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'sophie_custom_header_args', array(
		...
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'sophie_header_style',
		'admin-head-callback'    => 'sophie_admin_header_style',
		'admin-preview-callback' => 'sophie_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', 'sophie_custom_header_setup' );

if ( ! function_exists( 'sophie_header_style' ) ) :
/**
